...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissGermGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissGermGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerEinBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `GerGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `GerGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissGermGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerForGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissGermGermGerm' & `grandsCorMissGermGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `GerForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `MisMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebMigraEarly' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraEarly' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerGebMigraMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerGebMigraMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerEinMigraMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerEinMigraMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForGerMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisMigraEarly' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForGerMisMigraMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForGerMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeGermMiss' & `grandsCorForeForeGermMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeGermMiss' & `grandsCorForeForeGermMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForMisMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForMisMisMigraMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForGebBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForGebMigraMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForEinBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinMigraEarly' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinMigraMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForEinMigraMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForEinMigraMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForEinMigraMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinGerman' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeForeGermMiss' & `grandsCorForeForeGermMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeForeGermMiss' & `grandsCorForeForeGermMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissGermGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanGerman' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinGerman' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorGermanForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeFore' & `grandsCorForeForeForeFore'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeForeMiss' & `grandsCorForeForeForeMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisBirthMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissGerm' & `grandsCorForeMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatGermanGerman' & `parentsCorForeigForeig' & `grandsNatMissMissMissGerm' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissGerm' & `grandsCorMissMissMissGerm'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissGermGerm' & `grandsCorMissMissGermGerm'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeForeMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeForeMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraEarly' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatForeMissMissMiss' & `grandsCorForeMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraMiss' & `parentsNatMissinMissin' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if `ForForMisMigraMiss' & `parentsNatGermanGerman' & `parentsCorGermanGerman' & `grandsNatGermGermGermGerm' & `grandsCorGermGermGermGerm'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatMissinGerman' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatMissinForeig' & `parentsCorMissinForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatMissinForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorGermanForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatGermanForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatForeigForeig' & `parentsCorMissinMissin' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
...
replace mig_gen_cn = -1 if  `ForForMisMigraMiss' & `parentsNatForeigForeig' & `parentsCorForeigForeig' & `grandsNatMissMissMissMiss' & `grandsCorMissMissMissMiss'
